class Solution:
    def findCheapestPrice(
        ...
        # WRONG
        def bellman_ford_iterk(
            distances: List[int], flights: List[List[int]], src: int, dst: int, k: int
        ):
            ...
            for _ in range(k + 1):
                ...
                source_vertices_within_k_hops = {
                    u for u in range(len(distances)) if distances[u] < float("inf")
                }
